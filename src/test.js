...
app.get('/saludar/:nombre', (req, res) => {
    nombre = ValidacionesHelper.getStringOrDefault(req.params.nombre, 'Anonimo')
...
app.get('/omdb/searchbypage', async (req, res) => {
    try {
        ...
        let titulo = ValidacionesHelper.getStringOrDefault(req.query.title, '')
        let pagina = ValidacionesHelper.getIntegerOrDefault(req.query.page, 0)
        if (titulo != '' && pagina != 0) {
